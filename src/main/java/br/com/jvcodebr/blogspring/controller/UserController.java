...
public class UserController {
    ...
    public ResponseEntity<String> auth(@RequestBody LoginUserDTO loginUserDTO) throws CustomException {
        return new ResponseEntity<>(userService.auth(loginUserDTO), HttpStatus.OK);
    }

    @PostMapping("/register")
    public ResponseEntity<UserDTO> register(@Valid @RequestBody UserCreateDTO userCreateDTO) throws CustomException {
